        ...
        >
          ...
          >
            <Flex
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Frame 136tts")}
            >
              <View
                width="40px"
                height="40px"
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Icondip")}
              >
                <Icon
                  width="30px"
                  height="30px"
                  ...
                  left="12.5%"
                  right="12.5%"
                  {...getOverrideProps(overrides, "Vectorims")}
                ></Icon>
              </View>
              <Text
                fontFamily="Inter"
              ...
              <Text
                ...
                {...getOverrideProps(
                  overrides,
                  "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.odc"
                )}
              ></Text>
            </Flex>
            <Flex
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Frame 376rec")}
            >
              <View
                width="40px"
                height="40px"
              ...
              >
                <Icon
                  ...
                  left="12.5%"
                  right="12.5%"
                  {...getOverrideProps(overrides, "Vectorddm")}
                ></Icon>
              </View>
              <Text
                fontFamily="Inter"
          ...
          >
            <Flex
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Frame 136uux")}
            >
              <View
                width="40px"
                height="40px"
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Iconiwj")}
              >
                <Icon
                  width="30px"
                  height="30px"
                  ...
                  left="12.5%"
                  right="12.5%"
                  {...getOverrideProps(overrides, "Vectorrna")}
                ></Icon>
              </View>
              <Text
                fontFamily="Inter"
              ...
              <Text
                ...
                {...getOverrideProps(
                  overrides,
                  "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.laq"
                )}
              ></Text>
            </Flex>
            <Flex
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Frame 376dvq")}
            >
              <View
                width="40px"
                height="40px"
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Iconcot")}
              >
                <Icon
                  width="30px"
                  height="30px"
                  ...
                  left="12.5%"
                  right="12.5%"
                  {...getOverrideProps(overrides, "Vectorbfp")}
                ></Icon>
              </View>
              <Text
                fontFamily="Inter"
              ...
              <Text
                ...
                {...getOverrideProps(
                  overrides,
                  "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.nds"
                )}
              ></Text>
            </Flex>
          </Flex>
