  ...
  return (
    ...
    >
        ...
        >
          ...
          >
            <MyIcon
              shrink="0"
              type="arrow-right"
              {...getOverrideProps(overrides, "MyIconykf")}
            ></MyIcon>
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Sharegyv")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
              ...
              whiteSpace="pre-wrap"
              children="Share"
              {...getOverrideProps(overrides, "Sharevyn")}
            ></Text>
            <MyIcon
              shrink="0"
              type="bookmark_border"
              {...getOverrideProps(overrides, "MyIconivu")}
            ></MyIcon>
            <MyIcon
              shrink="0"
              type="share"
            ...
            <MyIcon
              shrink="0"
              type="more_vert"
              {...getOverrideProps(overrides, "MyIconhvv")}
            ></MyIcon>
          </Flex>
        </Flex>
        <Image
      ...
      <Flex
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Read moreedx")}
      >
        <MyIcon
          shrink="0"
          type="arrow-right"
          {...getOverrideProps(overrides, "MyIconbxn")}
        ></MyIcon>
        <Text
          fontFamily="Inter"
          fontSize="16px"
          ...
          whiteSpace="pre-wrap"
          children="Read more"
          {...getOverrideProps(overrides, "Read moreaiv")}
        ></Text>
      </Flex>
    </Flex>
  );
