      ...
      >
        ...
        >
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7nsh")}
          >
            <Text
              fontFamily="Inter"
              fontSize="24px"
          ...
          <Divider
            ...
            {...getOverrideProps(overrides, "Divideroji")}
          ></Divider>
          <Flex
            gap="8px"
            direction="column"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7bjt")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          <Divider
            ...
            size="small"
            orientation="horizontal"
            {...getOverrideProps(overrides, "Dividerchr")}
          ></Divider>
          <Flex
            gap="8px"
            direction="column"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7zju")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
      ...
      >
        ...
        >
          ...
          <Flex
            ...
            alignItems="flex-start"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 28cis")}
          >
            <Button
              borderRadius="4px"
              display="flex"
              ...
              variation="primary"
              children="XXS"
              {...getOverrideProps(overrides, "Buttonpha")}
            ></Button>
            <Button
              border="1px SOLID rgba(0,0,0,0)"
              borderRadius="4px"
              ...
              variation="primary"
              children="XS"
              {...getOverrideProps(overrides, "Buttonpuy")}
            ></Button>
            <Button
              border="1px SOLID rgba(0,0,0,0)"
              borderRadius="4px"
              ...
              variation="primary"
              children="S"
              {...getOverrideProps(overrides, "Buttonsmh")}
            ></Button>
            <Button
              border="1px SOLID rgba(0,0,0,0)"
              borderRadius="4px"
              ...
              variation="primary"
              children="M"
              {...getOverrideProps(overrides, "Buttonviz")}
            ></Button>
          </Flex>
          <Flex
            gap="24px"
            ...
            alignItems="flex-start"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 28ufc")}
          >
            <Button
              gap="24px"
              border="1px SOLID rgba(0,0,0,0)"
              ...
              variation="primary"
              children="L"
              {...getOverrideProps(overrides, "Buttonmso")}
            ></Button>
            <Button
              gap="24px"
              border="1px SOLID rgba(0,0,0,0)"
              ...
              variation="primary"
              children="XL"
              {...getOverrideProps(overrides, "Buttonukh")}
            ></Button>
            <Button
              gap="24px"
              border="1px SOLID rgba(0,0,0,0)"
              ...
              variation="primary"
              children="2XL"
              {...getOverrideProps(overrides, "Buttonxku")}
            ></Button>
            <Button
              gap="24px"
              border="1px SOLID rgba(0,0,0,0)"
              ...
              variation="primary"
              children="3XL"
              {...getOverrideProps(overrides, "Buttonrxa")}
            ></Button>
          </Flex>
          <Text
            fontFamily="Inter"
