    ...
    >
      ...
      >
        <Flex
          ...
          {...getOverrideProps(overrides, "Frame 321pgv")}
        >
          <View
            height="80px"
            shrink="0"
          ...
          >
            <Text
              ...
              {...getOverrideProps(overrides, "ORGANIZATIONele")}
            ></Text>
            <Flex
              gap="16px"
              direction="row"
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Frame 321auw")}
            >
              <View
                width="24px"
                height="24px"
              ...
              <Text
                ...
                {...getOverrideProps(overrides, "Lorem Ipsumsfp")}
              ></Text>
            </Flex>
            <Flex
              gap="16px"
            ...
            >
              <View
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Iconaxj")}
              >
                <Icon
                  width="20px"
                  height="17px"
                  ...
                  left="8.33%"
                  right="8.33%"
                  {...getOverrideProps(overrides, "Vectorpro")}
                ></Icon>
              </View>
              <Text
                fontFamily="Inter"
                ...
                whiteSpace="pre-wrap"
                children="Lorem Ipsum"
                {...getOverrideProps(overrides, "Lorem Ipsumuuy")}
              ></Text>
            </Flex>
          </Flex>
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 321tqg")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
              ...
              whiteSpace="pre-wrap"
              children="ORGANIZATION"
              {...getOverrideProps(overrides, "ORGANIZATIONbvg")}
            ></Text>
            <Flex
              gap="16px"
              direction="column"
            ...
            >
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Iconvvk")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectorlgi")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumimt")}
                ></Text>
              </Flex>
              <Flex
                gap="16px"
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Icongeg")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectorkky")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsummgn")}
                ></Text>
              </Flex>
              <Flex
                gap="16px"
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Iconxxf")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectorkur")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumfnx")}
                ></Text>
              </Flex>
              <Flex
                gap="16px"
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Iconsex")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectorost")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumaui")}
                ></Text>
              </Flex>
              <Flex
                gap="16px"
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Icontbl")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectorunr")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumlxj")}
                ></Text>
              </Flex>
              <Flex
                gap="16px"
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Iconhfz")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectorqbo")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumvge")}
                ></Text>
              </Flex>
              <Flex
                gap="16px"
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Icongxp")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectorvoi")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumpcm")}
                ></Text>
              </Flex>
              <Flex
                gap="16px"
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Iconbsb")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectorsxu")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumnxy")}
                ></Text>
              </Flex>
            </Flex>
          </Flex>
        ...
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Frame 321wgw")}
        >
          <Divider
            width="385px"
            shrink="0"
          ...
          >
            ...
            >
              ...
              <Flex
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Frame 321eys")}
              >
                <Text
                  fontFamily="Inter"
                  fontSize="16px"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumvjd")}
                ></Text>
                <Text
                  fontFamily="Inter"
                  fontSize="14px"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumseg")}
                ></Text>
              </Flex>
            </Flex>
            <View
