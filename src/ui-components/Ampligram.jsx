  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Image
            ...
            borderRadius="160px"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "imagezeg")}
          ></Image>
          <Text
            fontFamily="Inter"
            fontSize="16px"
        ...
        >
          <View
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Iconsqu")}
          >
            <Icon
              width="4px"
              height="16px"
      ...
      <Image
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "imagerty")}
      ></Image>
      <Flex
        gap="16px"
        direction="row"
      ...
      >
        ...
        >
          <MyIcon
            ...
            {...getOverrideProps(overrides, "MyIconugp")}
          ></MyIcon>
          <MyIcon
            shrink="0"
            type="chat-bubble-outline"
            {...getOverrideProps(overrides, "MyIconfdq")}
          ></MyIcon>
          <MyIcon
            shrink="0"
            type="send"
            {...getOverrideProps(overrides, "MyIconfzk")}
          ></MyIcon>
        </Flex>
        <Flex
          gap="10px"
        ...
        >
          <View
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Iconiik")}
          >
            <Icon
              width="14px"
              height="18px"
              ...
              left="20.83%"
              right="20.83%"
              {...getOverrideProps(overrides, "Vectorafz")}
            ></Icon>
          </View>
        </Flex>
      </Flex>
